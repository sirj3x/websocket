...
class MiddlewareMakeCommand extends GeneratorCommand
{
     ...
     * @var string
     */
    protected $name = 'make:ws-middleware';
     ...
     * @var string
     */
    protected $description = 'Create a new middleware for websocket';
    ...
    {
        $stub = DIRECTORY_SEPARATOR . 'stubs' . DIRECTORY_SEPARATOR . 'middleware.stub';
    ...
    {
        return 'App\\Websocket\\Middleware';
    }
